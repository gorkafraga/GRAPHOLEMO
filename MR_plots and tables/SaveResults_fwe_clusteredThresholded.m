...
clear all 
close all
% EXPORT CLUSTERS FROM RESULTS  WITH FWE CORRECTION - 
...
for t=1:length(tasks)
    ...
    for c = 1:length(contrasts)
        ...
        currext = cell2mat(clusterExtensions(find(contains(clusterExtensions(:,1),currtask) & contains(clusterExtensions(:,2),currcontrasts)),3));        
            matlabbatch{1}.spm.stats.results.spmmat = {['O:\studies\grapholemo\analysis\LEMO_GFG\mri\2ndLevel\FeedbackLearning\' currtask '\LEMO_rlddm_v32\2Lv_GLM0_mopa_vpe\',currcontrasts,'\SPM.mat']};
            ...
            %matlabbatch{1}.spm.stats.results.conspec.extent = '';
