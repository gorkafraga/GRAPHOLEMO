...
function matlabbatch = create_GLM3(paths, task, subject,scans,rp,bad_scans)
...
pathSubject = fullfile(paths.study,paths.analysis,task,'1stlev_GLM3',subject);
...
for s=1:3
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).name = 'stimulus_onset_positive';
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).pmod.name = 'AS_active';
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).pmod.param = cell2mat(parameters(8,s));
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).pmod.poly = 1;
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).orth = 0;
    
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).name = 'stimulus_onset_negative';
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).pmod.name = 'AS_neg';
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).pmod.param = cell2mat(parameters(12,s));
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).pmod.poly = 1;
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).orth = 0;
    
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).name = 'feedback_onset';
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).onset = cell2mat(onsets(2,s));
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).duration = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).tmod = 0;
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).pmod.name = 'PE_tot';
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).pmod.param = cell2mat(parameters(7,s));
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).pmod.poly = 1; 
...
matlabbatch{3}.spm.stats.con.consess{2}.tcon.name = 'Main effect of positive stimulus onset';
matlabbatch{3}.spm.stats.con.consess{2}.tcon.weights = [1];
matlabbatch{3}.spm.stats.con.consess{2}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'Parametric modulation of stimulus onset by AS active';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'Main effect of negative stimulus onset';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [0 0 1];
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'Parametric modulation of negative stimulus onset by AS neg';
matlabbatch{3}.spm.stats.con.consess{5}.tcon.weights = [0 0 0 1];
matlabbatch{3}.spm.stats.con.consess{5}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'Main effect of FB';
matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [0 0 0 0 1];
matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'Parametric modulation of FB by PE';
matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [0 0 0 0 0 1];
