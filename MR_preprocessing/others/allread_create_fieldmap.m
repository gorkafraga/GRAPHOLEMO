function allread_create_fieldmap(b0Path, epiPath, b0index)
...
%Last edited: 2018/08/02
    ...
    if isempty(dir([ b0Dir,['\vdm5*_' num2str(b0index) '_1_*']])) || overwrite
        ...
        [echoes] = allread_get_b0_echoes(subject,b0index);
        ...
        matlabbatch{1}.spm.tools.fieldmap.calculatevdm.subj.defaults.defaultsval.mflags.template = {'O:\studies\allread\mri\template\T1.nii'};
