...
picture { text { caption="		<b>Willkommen zurück! </b>
						...
						Jetzt werden Sie nochmals die gleichen Symbole sehen, 
						aber dieses Mal mit Markierungen,  die ihre Laute verändern. 
					...
					oder ‘schneller’, wenn Sie zuviel Zeit gebraucht haben.		
						...
						Zuerst starten wir mit einer kurzen Auffrischung der Symbole und Laute, 
						die Sie gerade gelernt haben.
						
			 
						<i>Drücken Sie einen Knopf, um fortzufahren.</i>"; font= "Segoe UI emoji"; font_size=16;text_align=align_left; font_color=0,0,0;}refresh_txt; x=0; y=0;} refresh_txt_pic;


	picture { text { caption="			<b>Gut gemacht! </b>														
						Nun beginnen wir mit der aktuellen Aufgabe. 
					
						Nach jeder Antwort kriegen Sie ein Feedback: 
						korrekt (😊), inkorrekt (😕) oder ‘schneller’. 
		...
		loop int i = 1 until i> 48 begin
			...
			#..............................................................................................
				...
				# Output file:	 
					out_file.print(blockNum); out_file.print("\t"); 	# block nr
					out_file.print(i); out_file.print("\t"); 			# trial nr
					out_file.print(vStim1); out_file.print("\t"); 
