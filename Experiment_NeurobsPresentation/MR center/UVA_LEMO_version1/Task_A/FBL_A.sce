...
picture { text { caption="<b> Willkommen! </b>														
		In diesem Experiment lernen Sie eine Fantasieschrift.
			...
			Sie werden auf dem Bildschirm ein Symbol sehen und dazu einen Laut hören. 
												
															Drücken Sie den LINKEN Knopf, wenn Sie denken das Symbol gehört zum Laut,
															oder den RECHTEN Knopf, wenn sie nicht zusammen gehören.
															
															
															Nach jeder Antwort kriegen Sie ein Feedback: korrekt (😊), inkorrekt (😕) 
															oder ‘schneller’, wenn Sie zuviel Zeit gebraucht haben.													   
																														
															Versuchen Sie so schnell und richtig wie möglich zu antworten. 
															Antworten Sie auf alle Versuche.												 
									
											<i> Drücken Sie einen Knopf um fortzufahren. </i>"; font= "Segoe UI emoji";font_size=14;text_align=align_left; font_color=0,0,0;}instr_txt; x=0; y=0;} instr_txt_pic;
...
picture { text { caption="<b> Willkommen! </b>														
		In diesem Experiment lernen Sie eine Fantasieschrift.
			...
			Sie werden auf dem Bildschirm ein Symbol sehen und dazu einen Laut hören. 
															...
															Drücken Sie den RECHTEN Knopf, wenn Sie denken das Symbol gehört zum Laut,
															oder den LINKEN Knopf, wenn sie nicht zusammen gehören.
											...
											<i> Drücken Sie einen Knopf um fortzufahren. </i>"; font= "Segoe UI emoji";font_size=14;text_align=align_left; font_color=0,0,0;}instr_txt2; x=0; y=0;} instr_txt_pic2;
...
preset int blockNum;
preset int leftIsMatch;		# default right=match, left=mismatch
...
#headers in txt file
out_file.print("block\ttrial\tvStim\taStim\tresp\trt\tfb\titi\tfeedJitter\taFile\tvSymbol\tLeftIsMatch\tstimOnset\trespOnset\tfeedbackOnset\n");
...
#					end;
		...
		#..............................................................................................
		   	# Output file:	 
				...
				out_file.print(activeSnd[aStim]);out_file.print("\t");		# get_filename(snd.filename()));	# filename of the sound
				out_file.print(activePict[vStim1]);out_file.print("\t");		#  
				out_file.print(leftIsMatch);out_file.print("\t");		
