...
array{text{caption="N";preload=true;}FFtrainedB12_1; 
		...
		text{caption="A";preload=true;}FFtrainedB12_5;
		text{caption="E";preload=true;}FFtrainedB12_6;
		text{caption="I";preload=true;}FFtrainedB12_7;
		text{caption="0";preload=true;}FFtrainedB12_8;
	}FFtrained;
...
array{text{caption="N";preload=true;}FFtrainedB13_1; 
		...
		text{caption="i";preload=true;}FFtrainedB13_5;
		text{caption="a";preload=true;}FFtrainedB13_6;
		text{caption="e";preload=true;}FFtrainedB13_7;
		text{caption="6";preload=true;}FFtrainedB13_8;
	}FFtrainedBlocks13;
...
array{text{caption="N";preload=true;}FFtrainedB14_1; 
		...
		text{caption="n";preload=true;}FFtrainedB14_5;
		text{caption="r";preload=true;}FFtrainedB14_6;
		text{caption="v";preload=true;}FFtrainedB14_7;
		text{caption="9";preload=true;}FFtrainedB14_8;
	}FFtrainedBlocks14;
...
array{text{caption="A";preload=true;}FFtrainedB23_1; 
		...
		text{caption="a";preload=true;}FFtrainedB23_6;
		text{caption="e";preload=true;}FFtrainedB23_7;
		text{caption="6";preload=true;}FFtrainedB23_8;
	}FFtrainedBlocks23;
...
array{text{caption="A";preload=true;}FFtrainedB24_1; 
		...
		text{caption="n";preload=true;}FFtrainedB24_5;
		text{caption="r";preload=true;}FFtrainedB24_6;
		text{caption="v";preload=true;}FFtrainedB24_7;
		text{caption="9";preload=true;}FFtrainedB24_8;
	}FFtrainedBlocks24;
...
array <string> font_type[3] = {"lemo6","AllRead_MRFont2","BACS1"};
...
array<int> letterOrder[10]={1,2,3,4,5,6,7,8,9,9}; 
...
loop int k=1 until k>blocks_letter_array.count() begin	
...
FFnewOrder.shuffle(); 
   ...
   #Loop through conditions (letter/FFtrained/FFfamiliar/FFnew)
	...
	term.print(condition_order[j]); term.print("\n");	
	r=0; #count variable counting how often target has occurred (can occur a max of 2 times - defined in if statements)
		...
		if (condition_order[j]=="L") then
			isi_jitter.shuffle();	
				...
				elseif i < 10 && letterOrder[i] == 9 && targOccurrence==1 && r==1 then 
									i=i+1; continue;
				elseif i < 10 && letterOrder[i] == 9 && targOccurrence==0 then 
									i=i+1;  continue;
				elseif i == 10 && letterOrder[i] == 9 && targOccurrence==1 && r==1 then 
									i=i+1;  break;
				elseif i == 10 && letterOrder[i] == 9 && targOccurrence==0 then 
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				...
				elseif i < 10 && FFtrainedOrder[i] == 9 && targOccurrence==1 && r==1 then 
										i=i+1; continue;
				elseif i < 10 && FFtrainedOrder[i] == 9 && targOccurrence==0 then 
										i=i+1;  continue;
				elseif i == 10 && FFtrainedOrder[i] == 9 && targOccurrence==1 && r==1 then 
										i=i+1;  break;
				elseif i == 10 && FFtrainedOrder[i] == 9 && targOccurrence==0 then 
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				...
				elseif i < 10 && FFfamiliarOrder[i] == 9 && targOccurrence==1 && r==1 then 
								i=i+1; continue;
				elseif i < 10 && FFfamiliarOrder[i] == 9 && targOccurrence==0 then 
								i=i+1; continue;
				elseif i == 10 && FFfamiliarOrder[i] == 9 && targOccurrence==1 && r==1 then 
								i=i+1;   break;
				elseif i == 10 && FFfamiliarOrder[i] == 9 && targOccurrence==0 then 
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				...
				elseif i < 10 && FFnewOrder[i] == 9 && targOccurrence==1 && r==1 then 
							i=i+1; continue;
				elseif i < 10 && FFnewOrder[i] == 9 && targOccurrence==0 then
							i=i+1;continue;
				elseif i == 10 && FFnewOrder[i] == 9 && targOccurrence==1 && r==1 then 
							i=i+1; break;
				elseif i == 10 && FFnewOrder[i] == 9 && targOccurrence==0 then 
