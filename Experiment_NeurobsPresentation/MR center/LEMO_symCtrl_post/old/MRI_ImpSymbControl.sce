...
$FFlearned="AllRead-Hebrew";
$FFfamiliar="AllRead-Armenian";
$FFnew="AllRead-Arabic"; #same for familiar and new 
...
array{text{caption="b";preload=true;}letter1; 
		...
		text{caption="p";preload=true;}letter4;
		text{caption="d";preload=true;}letter5;
		text{caption="n";preload=true;}letter6;
		text{caption="e";preload=true;}letter7;
		text{caption="q";preload=true;}letter8;
		text{caption="b";preload=true;}letter9; 
		text{caption="m";preload=true;}letter10;
		text{caption="u";preload=true;}letter11;
		text{caption="p";preload=true;}letter12;
		text{caption="d";preload=true;}letter13;
		text{caption="n";preload=true;}letter14;
		text{caption="e";preload=true;}letter15;
		text{caption="q";preload=true;}letter16;
	}letter;
...
array{text{caption="o";preload=true;}FFtrainedB13_1; 
		text{caption="p";preload=true;}FFtrainedB13_2;
		text{caption="q";preload=true;}FFtrainedB13_3;
		text{caption="r";preload=true;}FFtrainedB13_4;
		...
		text{caption="o";preload=true;}FFtrainedB13_9; 
		text{caption="p";preload=true;}FFtrainedB13_10;
		text{caption="q";preload=true;}FFtrainedB13_11;
		text{caption="r";preload=true;}FFtrainedB13_12;
...
array{text{caption="s";preload=true;}FFtrainedB14_1; 
		text{caption="t";preload=true;}FFtrainedB14_2;
		text{caption="v";preload=true;}FFtrainedB14_3;
		text{caption="z";preload=true;}FFtrainedB14_4;
		...
		text{caption="s";preload=true;}FFtrainedB14_9; 
		text{caption="t";preload=true;}FFtrainedB14_10;
		text{caption="v";preload=true;}FFtrainedB14_11;
		text{caption="z";preload=true;}FFtrainedB14_12;
...
array{text{caption="a";preload=true;}FFtrainedB23_1; 
		...
		text{caption="o";preload=true;}FFtrainedB23_5;
		text{caption="p";preload=true;}FFtrainedB23_6;
		text{caption="q";preload=true;}FFtrainedB23_7;
		text{caption="r";preload=true;}FFtrainedB23_8;
		...
		text{caption="o";preload=true;}FFtrainedB23_13;
		text{caption="p";preload=true;}FFtrainedB23_14;
		text{caption="q";preload=true;}FFtrainedB23_15;
		text{caption="r";preload=true;}FFtrainedB23_16;
...
array{text{caption="a";preload=true;}FFtrainedB24_1; 
		...
		text{caption="s";preload=true;}FFtrainedB24_5;
		text{caption="t";preload=true;}FFtrainedB24_6;
		text{caption="v";preload=true;}FFtrainedB24_7;
		text{caption="z";preload=true;}FFtrainedB24_8;
		...
		text{caption="s";preload=true;}FFtrainedB24_13;
		text{caption="t";preload=true;}FFtrainedB24_14;
		text{caption="v";preload=true;}FFtrainedB24_15;
		text{caption="z";preload=true;}FFtrainedB24_16;
		text{caption="target";preload=true;}FFtrainedB24_target;
	}FFtrainedBackup2_B4;
	
array{text{caption="o";preload=true;}FFtrainedB1234_1; 
		text{caption="p";preload=true;}FFtrainedB1234_2;
		text{caption="q";preload=true;}FFtrainedB1234_3;
		text{caption="r";preload=true;}FFtrainedB1234_4;
		text{caption="s";preload=true;}FFtrainedB1234_5;
		text{caption="t";preload=true;}FFtrainedB1234_6;
		text{caption="v";preload=true;}FFtrainedB1234_7;
		text{caption="z";preload=true;}FFtrainedB1234_8;
		text{caption="o";preload=true;}FFtrainedB1234_9; 
		text{caption="p";preload=true;}FFtrainedB1234_10;
		text{caption="q";preload=true;}FFtrainedB1234_11;
		text{caption="r";preload=true;}FFtrainedB1234_12;
		text{caption="s";preload=true;}FFtrainedB1234_13;
		text{caption="t";preload=true;}FFtrainedB1234_14;
		text{caption="v";preload=true;}FFtrainedB1234_15;
		text{caption="z";preload=true;}FFtrainedB1234_16;
...
trial{stimulus_event{
	picture targetpic;
		duration=$stimPresDur;}targpicStimulus;
...
####################################################
preset int cbFonts;
array <string> font_type[3] = {"AllRead-Hebrew","AllRead-Arabic","AllRead-Armenian"};
#array <string> font_type2[3] = {"AllRead-Armenian","AllRead-Hebrew","AllRead-Arabic"};
#array <string> font_type3[3] = {"AllRead-Arabic","AllRead-Armenian","AllRead-Hebrew"};


if (cbFonts == '1') then font_type = font_type;
elseif (cbFonts == '2') then font_type = {"AllRead-Arabic","AllRead-Armenian","AllRead-Hebrew"};
elseif (cbFonts == '3') then font_type = {"AllRead-Armenian","AllRead-Hebrew","AllRead-Arabic"};
end;

####################################################
preset string backupblocks = "";

if (backupblocks.upper()[1]=='0') then FFtrained=FFtrained; letter=letter;

elseif (backupblocks.upper()[1]=='1' && backupblocks.upper()[2]=='3') then FFtrained=FFtrainedBackup1_B3; letter=letterBackup1_B3;
elseif (backupblocks.upper()[1]=='2' && backupblocks.upper()[2]=='3') then FFtrained=FFtrainedBackup2_B3; letter=letterBackup2_B3;

elseif (backupblocks.upper()[1]=='1' && backupblocks.upper()[2]=='4') then FFtrained=FFtrainedBackup1_B4; letter=letterBackup1_B4;
elseif (backupblocks.upper()[1]=='2' && backupblocks.upper()[2]=='4') then FFtrained=FFtrainedBackup2_B4; letter=letterBackup2_B4;

elseif (backupblocks.upper()[1]=='1' && backupblocks.upper()[2]=='2' && backupblocks.upper()[3]=='3' && backupblocks.upper()[3]=='4') then FFtrained=FFtrainedBackup12_B34; letter=letterBackup12_B34; end;
...
logfile.set_filename(logfilename.replace(".log",+"_B"+backupblocks+".log")); #replace .log with other input + .log
...
else outputfile.open("NoSubj_"+scenarioName+"_B"+backupblocks+".txt");
end;
		...
		if (condition_order[j]=="L") then
			...
			#A loop is started for the letter-condition; First, a fixation cross is shown, then the word is presented and so on
				...
				if letterOrder[i] == 17 && targOccurence==1 && r<1 then 
					...
					targpicStimulus.set_response_active(true);
					targetstimulus_trial.present();
					eventStimulus.set_event_code(event_code_letter_targ);
					eventStimulus.set_target_button(targButton);
					eventStimulus.set_port_code(port_code_letter_targ);
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>18 begin;
				if FFtrainedOrder[i] == 17 && targOccurence==1 && r<1 then 
					...
					targpicStimulus.set_response_active(true);
					targetstimulus_trial.present();
					eventStimulus.set_event_code(event_code_FFtrained_targ);
					eventStimulus.set_target_button(targButton);
					eventStimulus.set_port_code(port_code_FFtrained_targ);
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>18 begin;
				if FFfamiliarOrder[i] == 17 && targOccurence==1 && r<1 then 
					...
					targpicStimulus.set_response_active(true);
					targetstimulus_trial.present();
					eventStimulus.set_event_code(event_code_FFfamiliar_targ);
					eventStimulus.set_target_button(targButton);
					eventStimulus.set_port_code(port_code_FFfamiliar_targ);
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>18 begin;
				if FFnewOrder[i] == 17 && targOccurence==1 && r<1 then 
					...
					targpicStimulus.set_response_active(true);
					targetstimulus_trial.present();
					eventStimulus.set_event_code(event_code_FFnew_targ);
					eventStimulus.set_target_button(targButton);
					eventStimulus.set_port_code(port_code_FFnew_targ);
				...
				elseif i == 18 && FFnewOrder[i] == 17 && targOccurence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
					...
					term.print("else"); term.print("targ  "); term.print(targOccurence);term.print("FFnewOrder[i]");term.print(letterOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);
