...
If you think the symbol and the sound match press the <b>green</b> button. 
If not, press the <b>red</b> button. If you do not know the answer, try to guess.
...
Now the real test starts. It is a bit longer.
...
if (logfile.subject().count()>0) then out_file.open(logfile.subject()+"_LSB.txt");
