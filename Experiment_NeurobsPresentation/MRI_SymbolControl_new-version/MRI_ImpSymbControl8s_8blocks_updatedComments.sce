...
#Here, the fixation cross is defined. The fixation cross is part of the ISI, jittered (see later). 
...
#Here, the rest trials are defined. After each condition. Longer pause, counterbalanced(see later). 
