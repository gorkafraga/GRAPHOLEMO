...
array <int> randISIRest[3] = {5000,5000,13400};
array<int>isi_jitter[10]={493, 373, 441, 465, 136, 247, 384, 125, 226, 111}; #mean 300.1, between 100-500
...
#array<int>isi_jitter[10]={347, 512, 262, 430, 259, 561, 562, 135, 265, 581}; #mean 391.4, between 100-600
	...
	r=0; #count variable counting how often target has occurred (can occur a max of 2 times - defined in if statements)
		...
		if (condition_order[j]=="L") then
			...
			#A loop is started for the letter-condition; First, a fixation cross is shown, then the word is presented and so on
				...
				if letterOrder[i] == 9 && targOccurence==1 && r<1 then 
				...
				elseif letterOrder[i] == 9 && targOccurence==2 && r<2 then 
					term.print("if"); term.print("targ  "); term.print(targOccurence);term.print("letterOrder[i]");term.print(letterOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");
					targEventStimulus.set_response_active(true);
					targEventStimulus.set_event_code(event_code_letter_targ);
					targEventStimulus.set_target_button(targButton);
				...
				elseif i < 10 && letterOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && letterOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && letterOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && letterOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				if FFtrainedOrder[i] == 9 && targOccurence==1 && r<1 then 
					...
					targetstimulus_trial.present();
				r = r+1
				elseif FFtrainedOrder[i] == 9 && targOccurence==2 && r<2 then 
				...
				elseif i < 10 && FFtrainedOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && FFtrainedOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && FFtrainedOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurence);term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && FFtrainedOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				if FFfamiliarOrder[i] == 9 && targOccurence==1 && r<1 then 
					...
					targetstimulus_trial.present();
					r = r+1
				elseif FFfamiliarOrder[i] == 9 && targOccurence==2 && r<2 then 
				...
				elseif i < 10 && FFfamiliarOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && FFfamiliarOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurence);term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && FFfamiliarOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && FFfamiliarOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				if FFnewOrder[i] == 9 && targOccurence==1 && r<1 then 
					...
					targetstimulus_trial.present();
				r = r+1
					elseif FFnewOrder[i] == 9 && targOccurence==2 && r<2 then 
				...
				elseif i < 10 && FFnewOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && FFnewOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && FFnewOrder[i] == 9 && targOccurence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && FFnewOrder[i] == 9 && targOccurence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
