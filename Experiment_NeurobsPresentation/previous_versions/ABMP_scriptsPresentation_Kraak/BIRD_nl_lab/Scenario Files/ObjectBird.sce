...
picture { bitmap { filename = ""; preload=false; } pict; x=0; y=0; } pstim;
...
Kan jij erachter welke symbolen en geluiden bij elkaar horen? Succes!
...
if (logfile.subject().count()>0) then out_file.open(logfile.subject()+"_"+responseMatching+"_BIRD.txt");
