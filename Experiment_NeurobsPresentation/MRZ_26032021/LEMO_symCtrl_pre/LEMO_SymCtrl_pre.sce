...
Bereit...? "; font_size=14; font_color=0,0,0;}intro_txt; x=-10; y=0;} intro_pic;
...
#instructions
picture { text { caption=" 		
... noch ein paar Sekunden bis die Maschinen starten. Gleich gehts los!"; font_size=14; font_color=0,0,0;}start_txt; x=-10; y=0;} start_txt_pic;
...
array{text{caption="N";preload=true;}FFtrainedB12_1; 
		...
		text{caption="®";preload=true;}FFtrainedB12_5;
...
array{text{caption="N";preload=true;}FFtrainedB13_1; 
		...
		text{caption="®";preload=true;}FFtrainedB13_5;
...
array{text{caption="N";preload=true;}FFtrainedB14_1; 
		...
		text{caption="®";preload=true;}FFtrainedB14_5;
...
##FFnew
array{text{caption="c";preload=true;}FFnew1; 
		text{caption="l";preload=true;}FFnew2;
		text{caption="t";preload=true;}FFnew3;
		text{caption="u";preload=true;}FFnew4;
		text{caption="j";preload=true;}FFnew5;
		text{caption="p";preload=true;}FFnew6;
		text{caption="q";preload=true;}FFnew7;
		text{caption="h";preload=true;}FFnew8;
		text{caption="f";preload=true;}FFnew9;
		text{caption="t";preload=true;}FFnew10;
...
array <string> font_type[3] = {"lemo6","AllRead-Armenian","ERead_falsefont_AllRead"};
...
#output file
string scenarioName = "SymCtrlPre";
		...
		if (condition_order[j]=="L") then
			...
			loop int i=1 until i>10 begin;
				...
				if (targetPosition[i] == 1) then 
					...
					outputfile.print(blocks_letter_array[k][letterOrder[i]].caption() + "_target");outputfile.print("\t") ;
		...
		#--------------------------;
			...
			loop int i=1 until i>10 begin;
				...
				if (targetPosition[i] == 1) then
					...
					blocks_FFfamiliar_array[k][FFfamiliarOrder[i]].set_font_size(80);
		...
		#--------------------------;
			...
			loop int i=1 until i>10 begin;
				...
				if (targetPosition[i] == 1) then
					...
					blocks_FFnew_array[k][FFnewOrder[i]].set_font_size(80);
