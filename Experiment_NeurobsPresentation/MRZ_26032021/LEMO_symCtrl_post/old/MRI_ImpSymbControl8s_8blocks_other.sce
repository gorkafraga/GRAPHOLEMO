...
array<int> letterOrder[10]={1,2,3,4,5,6,7,8,9,9};  #make arrays for the letters to be presented twice each - these will be shuffled so that the order of letter presentation is randomized.
array<int> FFtrainedOrder[10]={1,2,3,4,5,6,7,8,9,9};
array<int> FFfamiliarOrder[10]={1,2,3,4,5,6,7,8,9,9};
array<int> FFnewOrder[10]={1,2,3,4,5,6,7,8,9,9};



#array <int> randISIRest[4] = {7000,7500,8000,8500};
#array <int> randISIRest[3] = {5000,5000,8000};
...
/*randISIRest.add{3000,5000,7000,9000});
randISIRest.add({9000,7000,5000,3000});
randISIRest.add({7000,3000,9000,5000});
randISIRest.add({5000,9000,3000,7000});
randISIRest.add({9000,3000,5000,7000});
randISIRest.add({7000,5000,9000,3000});
randISIRest.add({5000,7000,3000,9000});
randISIRest.add({3000,9000,7000,5000});*/

#array<int>isi_jitter[10]={203, 825, 780, 585, 404, 630, 166, 163, 272, 939}; #mean 496.7, between 100-900 
...
targOccArray.add({0,1,1,2});
targOccArray.add({1,1,2,0});
int r=0; #count variable such that if targOccurrence is 1, only one "9" in the Order arrays is used --> target occurs only once in a block. See further below in the conditional statements.
...
#randISIRest.shuffle(); #choose a random rest period/isi
	...
	term.print("targOccurrence"); term.print(targOccurrence);	
	r=0; #count variable counting how often target has occurred (can occur a max of 2 times - defined in if statements)
		...
		if (condition_order[j]=="L") then
			...
			#A loop is started for the letter-condition; First, a fixation cross is shown, then the word is presented and so on
				...
				if letterOrder[i] == 9 && targOccurrence==1 && r<1 then 
					...
					eventFixation.set_target_button(targButton);
					fixation_trial.present();
				r = r+1;
				
				elseif letterOrder[i] == 9 && targOccurrence==2 && r<2 then 
					term.print("if"); term.print("targ  "); term.print(targOccurrence);term.print("letterOrder[i]");term.print(letterOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");
					targEventStimulus.set_response_active(true);
					targEventStimulus.set_event_code(event_code_letter_targ);
					targEventStimulus.set_target_button(targButton);
				...
				elseif i < 10 && letterOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && letterOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && letterOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && letterOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;

				else 
					term.print("else"); term.print("targ  "); term.print(targOccurrence);term.print("letterOrder[i]");term.print(letterOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				if FFtrainedOrder[i] == 9 && targOccurrence==1 && r<1 then 
					...
					fixation_trial.present();
				r = r+1
				elseif FFtrainedOrder[i] == 9 && targOccurrence==2 && r<2 then 
					term.print("elseif1 "); term.print("targ  "); term.print(targOccurrence);term.print("FFtrainedOrder[i]");term.print(FFtrainedOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");
					targEventStimulus.set_response_active(true);
					targEventStimulus.set_event_code(event_code_FFtrained_targ);
					targEventStimulus.set_target_button(targButton);
					targEventStimulus.set_port_code(port_code_FFtrained_targ);
				...
				elseif i < 10 && FFtrainedOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && FFtrainedOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && FFtrainedOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurrence);term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && FFtrainedOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				if FFfamiliarOrder[i] == 9 && targOccurrence==1 && r<1 then 
					...
					r = r+1
				elseif FFfamiliarOrder[i] == 9 && targOccurrence==2 && r<2 then 
					term.print("elseif1 "); term.print("targ  "); term.print(targOccurrence);term.print("FFfamiliarOrder[i] ");term.print(FFfamiliarOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");
					targEventStimulus.set_response_active(true);
					targEventStimulus.set_event_code(event_code_FFfamiliar_targ);
					targEventStimulus.set_target_button(targButton);
					targEventStimulus.set_port_code(port_code_FFfamiliar_targ);
				...
				elseif i < 10 && FFfamiliarOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && FFfamiliarOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurrence);term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && FFfamiliarOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && FFfamiliarOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
		...
		isi_jitter.shuffle();
			...
			loop int i=1 until i>10 begin;
				...
				r = r+1
					elseif FFnewOrder[i] == 9 && targOccurrence==2 && r<2 then 
					term.print("elseif1 "); term.print("targ  "); term.print(targOccurrence);term.print("FFnewOrder[i] ");term.print(FFnewOrder[i]); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");
					targEventStimulus.set_response_active(true);
					targEventStimulus.set_event_code(event_code_FFnew_targ);
					targEventStimulus.set_target_button(targButton);
					targEventStimulus.set_port_code(port_code_FFnew_targ);
				...
				elseif i < 10 && FFnewOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif2"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i < 10 && FFnewOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif3"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");continue;
				elseif i == 10 && FFnewOrder[i] == 9 && targOccurrence==1 && r==1 then i=i+1; term.print("elseif4"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
				elseif i == 10 && FFnewOrder[i] == 9 && targOccurrence==0 then i=i+1; term.print("elseif5"); term.print("targ  "); term.print(targOccurrence); term.print("  "); term.print("r");term.print(r); term.print("  "); term.print("i");term.print(i);term.print("\n");break;
