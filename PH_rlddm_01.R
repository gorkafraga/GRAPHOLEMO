...
fit <- rstan::sampling(object  = stanmodel,
                       data    = dat,
                       pars    = c("alpha","v_mod","tau","assoc_active_pair","assoc_inactive_pair","delta_hat","pe_hat","mu_alpha","mu_v_mod","mu_tau","log_lik"),
                       #init    = "random",
                       chains  = 4,
                       iter    = 9000,
                       warmup  = 3000,
...
saveRDS(fit, "fit_rlddm01.rds")
fit <- readRDS("C:/Rscripts/modeling_data/rlddm01.rds")
