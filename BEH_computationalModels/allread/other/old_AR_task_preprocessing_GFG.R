...
#--------------------------------------------------------------------------------------------
#set dirs
logfolder <-  'O:/studies/allread/mri/analysis_GFG/stats/task/logs/raw'
diroutput <- "O:/studies/allread/mri/analysis_GFG/stats/task/modelling/RLDDM"
...
#  raw_data$iter <- iter
  ...
  datList <- list("N" = n_subj,
                  ...
                  "iter" = datTable$trial, #iter 	(trial indexes per subject, across blocks)
