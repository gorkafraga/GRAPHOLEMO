...
#=============================================================================================================================
# INPUTS
model <- 'LEMO_rlddm_v11'

# dirinput <- paste0("G:/GRAPHOLEMO/tmp_models/fits/",model,"/")
dirinput <-  paste0("O:/studies/grapholemo/analysis/LEMO_GFG/beh/modeling/analysis_n39/fbl_a/",model,"/")
# dirPreprocessed <-paste0("G:/GRAPHOLEMO/tmp_models/")
dirPreprocessed <-paste0("O:/studies/grapholemo/analysis/LEMO_GFG/beh/modeling/analysis_n39/fbl_a/data_preprocessed")
diroutput <- dirinput
...
AScombo <- 
  ggdraw() +
  draw_plot(TRIALPLO[[1]], x = 0, y = 0, width = 1 , height = 3/3)  
#draw_plot(TRIALPLO[[4]], x = 0, y = 3/4, width = 1 , height = 1/4) 
