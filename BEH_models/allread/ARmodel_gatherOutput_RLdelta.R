...
#=============================================================================================================================
# INPUTS
model <- 'bandit2arm_delta'

#dirinput <- paste0("O:/studies/allread/mri/analysis_GFG/stats/task/modelling/RLDDM_fromLocal/GoodPerf_72/outputs/out_",model,"/")
dirinput <- paste0("O:/studies/allread/mri/analysis_GFG/stats/task/modelling/RL_delta/GoodPerf_72/output_",model)
#dirPreprocessed <-"O:/studies/allread/mri/analysis_GFG/stats/task/modelling/RLDDM_fromLocal/GoodPerf_72/"
dirPreprocessed <-"O:/studies/allread/mri/analysis_GFG/stats/task/modelling/RL_delta/GoodPerf_72/"
diroutput <- dirinput
...
fit <- readRDS(paste0(dirinput,'/fit.rds')) # read model output
...
if (model == 'bandit2arm_delta'){
   list_param_bySubject <- c("A","muAu","v_mod","eta_pos","eta_neg") 
   list_param_byTrial <- c("as_chosen","as_active","as_inactive","pe_tot_hat","pe_pos_hat","pe_neg_hat","v_hat") 
   
}else if (model=='AR_rlddm_v12' || model=='AR_rlddm_v22' || model=='AR_rlddm_v32'){
