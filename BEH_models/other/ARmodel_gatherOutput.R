...
# PLOTS  AND SUMMARY TABLES #
 #------------------------------------------------------------------------------------------------------
  ...
  # Save 
  setwd(diroutput)
  outputname <- paste("SubjectParameters_",choiceModel,".jpg",sep="")
 ...
 #----------------------------------------------------------------------------
  ...
  reg2plot <- c( "mc_pe_pos_hat","mc_pe_neg_hat","mc_pe_tot_hat")
   ...
   # Save 
   setwd(diroutput)
   outputname <- paste("PredictionError_",choiceModel,".jpg",sep="")
...
#-------------------------------------------------------------------------------------------------------------------------------------------
   ...
   # Save 
   setwd(diroutput)
   outputname <- paste("AsocStrength_",choiceModel,".jpg",sep="")
