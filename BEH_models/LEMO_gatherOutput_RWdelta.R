...
#=============================================================================================================================
# INPUTS
model <- 'lemo_bandit2arm_delta'
dirinput <- paste0("O:/studies/grapholemo/analysis/LEMO_GFG/beh/modeling/analysis_n39/",model)
diroutput <- paste0("O:/studies/grapholemo/analysis/LEMO_GFG/beh/modeling/analysis_n39/",model,"/output")

# Parameters of interest
list_param_bySubject <- c("A","tau") 
list_param_byTrial <- c("PE","ev")
...
# READ DATA
setwd(dirinput)
load(paste(dirinput,"/input/Preproc_data.rda",sep="")) #read gathered data (that will be combined with model parameters later)
load(paste(dirinput,"/input/Preproc_list.rda",sep="")) #read list with gather data input for model
fit <- readRDS(paste(dirinput,'/output/',model,'.rds',sep="")) # read model output
