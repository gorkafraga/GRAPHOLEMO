...
#--------------------------------------------------------------------------------------------
#set dirs
logfolder <-  'O:/studies/grapholemo/analysis/LEMO_GFG/mri/preprocessing/fbl_B/'
firstlevelfolder <- 'O:/studies/grapholemo/analysis/LEMO_GFG/mri/1stLevel/FBL_B/'
...
if (length(selectedfiles)==0){ 
  stop('no files were selected.Check again.EXECUTION STOPS')
    ...
    destinationDir <- paste0(diroutput,"Logs_preprocessed_n",length(subjects))
