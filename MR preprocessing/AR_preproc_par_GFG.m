...
%-------------------------------------------------------------------------------------
 ...
 save([paths.preprocessing,['batches\Batch_',currTask,'_',datestr(now,'mmddyyyy-HHMM'),'.mat']],'batch')
end
toc
