...
dependentvariable <- 'proportionPerThird'
taskpart <- 'FBL_B'
# Edit Paths
dirinput <- "O:/studies/grapholemo/analysis/LEMO_GFG/beh/" 
diroutput <-  "O:/studies/grapholemo/analysis/LEMO_GFG/beh/stats/LMM_R/_per task" 
...
formula_fixed <- as.formula(paste0(dependentvariable,'~ third*block') )
...
outputnamebase <- paste0('LMM_',dependentvariable,'_',taskpart)
