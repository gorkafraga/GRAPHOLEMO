...
#set ins and outs
dirinput <-"O:/studies/grapholemo/analysis/LEMO_GFG/beh/modeling/analysis_n39/data_preprocessed/Copy_source_files" 
diroutput <-"O:/studies/grapholemo/analysis/LEMO_GFG/beh/modeling/analysis_n39/data_preprocessed/" 
...
#loop thru files
setwd(dirinput)
files <- dir(path = dirinput,pattern = paste0('*.',task,'.*.txt'),recursive = TRUE)
