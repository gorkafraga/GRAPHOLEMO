 function [matlabbatch] =  LEMO_func_create_1Lv_GLM0_halfs(pathSubject,scans,onsets,nsessions)
    if nargin < 1
...
%% BATCH FOR 1st LEVEL %%%%%%%%
    ...
    for s=1:nsessions
        ...
        % onsets1 
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).name = 'stim_half1';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).onset = onsets(s).stimOnset_half1;
        ...
        % onsets2 
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).name = 'stim_half2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).onset = onsets(s).stimOnset_half2;
        ...
        %
        % onsets3 
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).name = 'fb_half1';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).onset = onsets(s).feedbackOnset_half1;
        ...
        % onsets4
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(4).name = 'fb_half2';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(4).onset = onsets(s).feedbackOnset_half2;
