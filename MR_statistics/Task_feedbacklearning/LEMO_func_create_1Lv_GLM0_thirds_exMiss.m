function [matlabbatch] =  LEMO_func_create_1Lv_GLM0_thirds_exMiss(pathSubject,scans,onsets,nsessions)
    if nargin < 1
...
%% BATCH FOR 1st LEVEL %%%%%%%%
    ...
    matlabbatch{3}.spm.stats.con.consess{6}.tcon.name = 'stim third1';
    matlabbatch{3}.spm.stats.con.consess{6}.tcon.weights = [1 0 0 0 0 0];
    matlabbatch{3}.spm.stats.con.consess{6}.tcon.sessrep = 'repl';
    
    matlabbatch{3}.spm.stats.con.consess{7}.tcon.name = 'stim third3 ';
    matlabbatch{3}.spm.stats.con.consess{7}.tcon.weights = [0 0 1 0 0 0];
    matlabbatch{3}.spm.stats.con.consess{7}.tcon.sessrep = 'repl';
    
    matlabbatch{3}.spm.stats.con.consess{8}.tcon.name = 'fb third1';
    matlabbatch{3}.spm.stats.con.consess{8}.tcon.weights = [0 0 0 1 0 0];
    matlabbatch{3}.spm.stats.con.consess{8}.tcon.sessrep = 'repl';
     
    matlabbatch{3}.spm.stats.con.consess{9}.tcon.name = 'fb third3';
