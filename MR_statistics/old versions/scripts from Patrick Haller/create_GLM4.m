...
function matlabbatch = create_GLM4(paths, task, subject,scans,rp,bad_scans)
...
pathSubject = fullfile(paths.study,paths.analysis,task,'1stlev_GLM4',subject);
...
for s=1:3
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).pmod.name = 'drift_rate';
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).pmod.param = cell2mat(parameters(4,s));
    ...
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).pmod.name = 'PE_tot';
    matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).pmod.param = cell2mat(parameters(7,s));
...
matlabbatch{3}.spm.stats.con.consess{3}.tcon.name = 'parametric modulation of stimulus onset by drift rate';
matlabbatch{3}.spm.stats.con.consess{3}.tcon.weights = [0 1];
matlabbatch{3}.spm.stats.con.consess{3}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{4}.tcon.name = 'Feedback onset';
matlabbatch{3}.spm.stats.con.consess{4}.tcon.weights = [0 0 1];
matlabbatch{3}.spm.stats.con.consess{4}.tcon.sessrep = 'repl';

matlabbatch{3}.spm.stats.con.consess{5}.tcon.name = 'parametric modulation of feedback onset by PE';
