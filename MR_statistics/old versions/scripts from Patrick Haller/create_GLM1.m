...
function matlabbatch = create_GLM1(paths, task, subject,scans,rp,bad_scans)
...
try
    ...
    [onsets] = get_fbl_onsets_model( fullfile(paths.study,paths.logs,task,subject,logfile) );
catch MExc
...
pathSubject = fullfile(paths.study,paths.analysis,task,'\1stlev_GLM1',subject);
