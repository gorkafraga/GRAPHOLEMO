function [matlabbatch] =  AR_create_1Lv_GLM0_positiv_first10_last10(pathSubject,scans,onsets,nsessions)
    if nargin < 1
...
%% BATCH FOR 1st LEVEL %%%%%%%%
    ...
    for s=1:nsessions
        ...
        % onsets1 
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).name = 'stimOnset_pos_first10';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(1).onset =  onsets(s).stimOnset_pos_first10;
        ...
        % onsets2 
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).name = 'stimOnset_pos_last10';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(2).onset = onsets(s).stimOnset_pos_last10;
        ...
        % onsets3 
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).name = 'fbOnset_pos_first10';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(3).onset = onsets(s).fbOnset_pos_first10;
        ...
        % onsets4
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(4).name = 'fbOnset_pos_last10';
        matlabbatch{1}.spm.stats.fmri_spec.sess(s).cond(4).onset = onsets(s).fbOnset_pos_last10;
